      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-emerald-700">Student Loan Repayment Simulator</h1>
          </div>
          <div className="p-4 bg-white rounded-lg border border-emerald-200 shadow-sm mb-6">
