...
export const QuickUnderstand = () => {
  return (
    <section id="financial-tools" className="py-16 bg-emerald-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md border border-emerald-100 flex flex-col transition-all duration-300 hover:shadow-xl hover:border-emerald-200">
            ...
            <div className="bg-emerald-50 p-3 rounded-lg mb-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-emerald-700">A 0.5% lower interest rate can save $20,000+ on a 30-year mortgage</p>
              </div>
            </div>
            <Link 
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border border-emerald-100 flex flex-col transition-all duration-300 hover:shadow-xl hover:border-emerald-200">
            ...
            <div className="bg-emerald-50 p-3 rounded-lg mb-4">
              <div className="flex items-start gap-2">
                <Lightbulb className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <p className="text-sm text-emerald-700">A larger down payment can reduce your total interest by thousands</p>
              </div>
            </div>
            <Link 
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border border-emerald-100 flex flex-col transition-all duration-300 hover:shadow-xl hover:border-emerald-200">
            ...
            <div className="bg-emerald-50 p-3 rounded-lg mb-4">
              <div className="flex items-start gap-2">
                <Lightbulb className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <p className="text-sm text-emerald-700">Paying just $50 more per month can cut years off your debt timeline</p>
              </div>
            </div>
            <Link 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-2xl mx-auto">
          <div className="bg-white p-6 rounded-xl shadow-md border border-emerald-100 flex flex-col transition-all duration-300 hover:shadow-xl hover:border-emerald-200">
            ...
            <div className="bg-emerald-50 p-3 rounded-lg mb-4">
              <div className="flex items-start gap-2">
                <Lightbulb className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <p className="text-sm text-emerald-700">Understand your true loan costs with detailed amortization schedules</p>
              </div>
            </div>
            <Link 
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border border-emerald-100 flex flex-col transition-all duration-300 hover:shadow-xl hover:border-emerald-200">
            ...
            <div className="bg-emerald-50 p-3 rounded-lg mb-4">
              <div className="flex items-start gap-2">
                <Lightbulb className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <p className="text-sm text-emerald-700">Starting just 5 years earlier can double your retirement savings</p>
              </div>
            </div>
            <Link 
