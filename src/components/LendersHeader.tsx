    ...
    <div className="text-center mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          <Shield className="h-8 w-8 text-gray-700 mx-auto mb-4" />
          <h3 className="font-semibold mb-2 text-gray-900">Bank-Level Security</h3>
          <p className="text-sm text-gray-600">Your data is protected with industry-standard encryption</p>
        </div>
        
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          <BadgeCheck className="h-8 w-8 text-gray-700 mx-auto mb-4" />
          <h3 className="font-semibold mb-2 text-gray-900">Soft Credit Check</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <h3 className="font-semibold mb-2 text-gray-900">Compare Instantly</h3>
